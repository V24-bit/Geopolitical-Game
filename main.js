// === SFONDO MOSAICO DI BANDIERE ANIMATE CHE COMBACIANO CON LO SCHERMO ===
...
function createFlagGrid() {
    ...
    // correzione per combaciare perfettamente
    colWidth = ww / gridCols;
    rowHeight = wh / gridRows;

    // Aggiorna le dimensioni della grid per coprire tutto senza buchi
